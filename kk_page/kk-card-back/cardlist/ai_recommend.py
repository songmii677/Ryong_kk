...
{{
  ...
  "type_reason": "사용자 유형을 설명하는 짧은 문장 1개",
  "common_benefits": "추천 카드들의 공통 장점을 짧게 요약한 문장 1개",
  "recommend_reason": "이 3장을 고른 전체 이유를 짧게 요약한 문장 1개",
  "card_reasons": [
    {{
      "card_id": 1,
      "reason": "카드별 추천 이유를 40자 안팎으로 작성"
    }}
  ]
}}
